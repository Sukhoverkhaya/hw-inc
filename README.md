...
Фраза, выбранная в меню, может быть добавлена в заключение в другой формулировке (отличной от той, что используется в меню выбора). Это возможно благодаря системе шаблонов, подробнее о применении которой можно прочитать [здесь](#Шаблоны).
...
2. Если у фразы есть поле ***phrase***, необходимо отредактировать формулировку в нём для соответствия желаемой, используя символы [системы шаблонов](#Шаблоны).
